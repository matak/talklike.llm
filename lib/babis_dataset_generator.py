...
class BabisDatasetGenerator:
    def __init__(self, templates_file: str = '../1_data_preparation/babis_templates_400.json', 
                 output_dir: str = '../data/generated_batches',
                 models_file: str = '../availablemodels.json'):
        """
        Inicializace generátoru s OpenAI klientem.
        
        Args:
            templates_file: Cesta k souboru se šablonami (výchozí '../1_data_preparation/babis_templates_400.json')
            output_dir: Adresář pro ukládání vygenerovaných dávek (výchozí '../data/generated_batches')
    ...
    def _load_system_prompt(self) -> str:
        ...
        try:
            with open('../1_data_preparation/LLM.CreateAnswers.systemPrompt.md', 'r', encoding='utf-8') as f:
                return f.read()
        except FileNotFoundError:
            raise FileNotFoundError("Soubor ../1_data_preparation/LLM.CreateAnswers.systemPrompt.md nebyl nalezen")
