...
class BabisDialogGenerator:
    ...
    def _load_system_prompt(self) -> str:
        ...
        try:
            with open('../1_data_preparation/LLM.CreateDialogue.systemPrompt.md', 'r', encoding='utf-8') as f:
                return f.read()
        except FileNotFoundError:
            raise FileNotFoundError("Soubor ../1_data_preparation/LLM.CreateDialogue.systemPrompt.md nebyl nalezen")
    ...
    def process_all_batches(self, input_dir: str = '../data/generated_batches', output_dir: str = '../data/final', model: str = None, batch_size: int = 10) -> List[str]:
        """
